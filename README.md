...
Since there is no info for User Registration , so i assumed that i will be getting following data in **Request Body** at the time of user Registration
- first_name: 
- last_name: 
...
#### transaction Api 
  ...
  **Add transaction**
   ...
   **Delete Transaction belonging to a user**
   Steps: 
   1. find the transaction from transaction collection belonging to transaction id
